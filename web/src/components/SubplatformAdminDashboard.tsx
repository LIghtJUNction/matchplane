    ...
    <div className="dashboard subplatform-admin-dashboard">
      ...
      <section className="surface seller-upload" aria-labelledby="email-config-title">
        ...
        <form className="seller-upload-form" onSubmit={save}>
          ...
          <label htmlFor="email-secret-ref"><span>Secret reference（不填密码）</span><input id="email-secret-ref" value={credentialSecretRef} onChange={(event) => setCredentialSecretRef(event.target.value)} placeholder="例如 secret://mail/auto" /></label>
