...
function memoryCopy(locale: "zh" | "en") {
  return locale === "en"
    ...
    : {
        ...
        saveFailed: "暂时无法保存设置。",
        revisionFailed: "AI 暂时无法修改购物记忆。",
        deleteFailed: "暂时无法删除购物记忆。",
        automationTitle: "AI 自动总结",
        automationOn: "购物对话中出现新的长期需求时，AI 会更新这份摘要。",
        automationOff: "暂停期间，AI 不会读取或更新这些内容。",
        pause: "暂停",
        resume: "恢复",
        paused: "已暂停自动记忆。",
        resumed: "已恢复自动记忆。",
        summaryEyebrow: "AI 记住了什么",
        summaryTitle: "当前摘要",
        updated: "更新于",
        emptyTitle: "还没有形成记忆",
        emptyBody: "继续和导购交流需求，或直接在下面告诉 AI 需要记住什么。",
        reviseEyebrow: "与 AI 核对",
        reviseTitle: "提出修改建议",
        reviseHint:
          "像聊天一样说明要改什么；AI 会更新结构化摘要，并告诉你实际改动。",
        revisionConversation: "购物记忆修改对话",
        suggestionLabel: "告诉 AI 如何修改",
        suggestionPlaceholder: "例如：预算改成 8000 元，并删除品牌偏好",
        suggestionPrivacy:
          "这里只保留长期购物需求，请勿填写密码、联系方式、地址或支付信息。",
        revising: "正在更新…",
        reviseAction: "让 AI 更新",
        retry: "重试",
        deleteAll: "清空全部记忆",
        deleteConfirm: "确认清空",
